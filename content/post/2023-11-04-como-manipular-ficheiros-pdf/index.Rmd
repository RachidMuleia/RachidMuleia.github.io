---
title: Como manipular ficheiros pdf em <i class="fab fa-r-project" aria-hidden="true" style="color:#035AA6"></i> nunca pára de me supreender, e sempre tenho tido, com o  <i class="fab fa-r-project" aria-hidden="true" style="color:#035AA6"></i> 
author: ''
date: '2023-11-04'
...
tags: []
subtitle: ''
summary: 'Manipulação de ficheiros em pdf'
authors: []
